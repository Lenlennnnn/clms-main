...
if (empty($userid) || empty($_SESSION['clms_loggedin']) || $_SESSION['clms_loggedin'] === false) {
...
<div class="sidebar pe-4 pb-3 navbar-dark-bg">
    <nav class="navbar bg-transparent">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="sessioncodes.php" class="nav-item nav-link <?php echo $currentpage == "List of Sessions" ? "active" : null; ?>"><i class="icon-dark-bg fa fa-qrcode me-2"></i>Session Codes</a>
        </div>
    </nav>
</div>
<!-- Sidebar End -->
...
<div class="content content-dark-bg">
    ...
    <nav class="navbar navbar-expand  sticky-top px-4 py-0 navbar-dark-bg">
        ...
        <div class="date-lab">
            <h3 class="m-0 fw-bold"><?php echo isset($_SESSION['clms_lab_name']) ? $_SESSION['clms_lab_name'] : null; ?></h3>
            ...
            <input type="hidden" id="userIDSession" value="<?php echo $_SESSION['clms_userid'] ?>">
            <div id="dateTime"></div>
        </div>
